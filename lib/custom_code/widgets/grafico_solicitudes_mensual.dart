...
class GraficoSolicitudesMensual extends StatefulWidget {
  const GraficoSolicitudesMensual({
    super.key,
    this.width,
    this.height,
  });
  ...
  @override
  State<GraficoSolicitudesMensual> createState() =>
      _GraficoSolicitudesMensualState();
}

class _GraficoSolicitudesMensualState extends State<GraficoSolicitudesMensual> {
