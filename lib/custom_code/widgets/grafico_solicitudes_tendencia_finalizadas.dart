...
class GraficoSolicitudesTendenciaFinalizadas extends StatefulWidget {
  const GraficoSolicitudesTendenciaFinalizadas({
    super.key,
    this.width,
    this.height,
  });
  ...
  @override
  State<GraficoSolicitudesTendenciaFinalizadas> createState() =>
      _GraficoSolicitudesTendenciaFinalizadasState();
}

class _GraficoSolicitudesTendenciaFinalizadasState
    extends State<GraficoSolicitudesTendenciaFinalizadas> {
  List<FlSpot> spots = [];
  List<String> labels = [];
  bool isLoading = true;
  String error = '';
