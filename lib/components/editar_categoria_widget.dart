...
class EditarCategoriaWidget extends StatefulWidget {
  const EditarCategoriaWidget({
    super.key,
    required this.categoriarow,
  });

  final VwResumenCategoriasRow? categoriarow;
...
class _EditarCategoriaWidgetState extends State<EditarCategoriaWidget> {
  ...
  void initState() {
    ...
    _model.textController ??=
        TextEditingController(text: widget!.categoriarow?.nombre);
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataIconss = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadDataIconss =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataIconss =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataIconss =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                                  ...
                                  child: Image.network(
                                    _model.uploadedFileUrl_uploadDataIconss !=
                                            ...
                                            _model.uploadedFileUrl_uploadDataIconss !=
                                                ''
                                        ? _model
                                            .uploadedFileUrl_uploadDataIconss
                                        : widget!.categoriarow!.imagenUrl!,
                                    width: 200.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
