...
import 'ver_servicio_model.dart';
export 'ver_servicio_model.dart';

class VerServicioWidget extends StatefulWidget {
  const VerServicioWidget({
    super.key,
    this.subcategoriaid,
  ...
  @override
  State<VerServicioWidget> createState() => _VerServicioWidgetState();
}

class _VerServicioWidgetState extends State<VerServicioWidget> {
  late VerServicioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerServicioModel());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowDropDown<String>(
                                      ...
                                      hintText: containerServiciosRow?.estado,
                                      icon: Icon(
                                    ...
                                    Switch.adaptive(
                                      value: _model.switchDestacadoValue ??=
                                          containerServiciosRow!.destacado,
                                      onChanged: (containerServiciosRow
                                                  ?.destacado !=
                                              null)
                                          ? null
                                          : (newValue) async {
