...
/// Se debe seleccionar entre Material o Mano de Obra, abajo se debe anotar
                                ...
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    child: Notificacion2Widget(
                                      titulo: 'Error',
                                      texto: 'Ingresa todos los campos',
                                      boton: 'Aceptar',
                                      succes: false,
                                      action: () async {
                                        Navigator.pop(context);
