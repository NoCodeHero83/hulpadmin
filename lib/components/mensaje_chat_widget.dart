...
import 'mensaje_chat_model.dart';
export 'mensaje_chat_model.dart';
...
class _MensajeChatWidgetState extends State<MensajeChatWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MensajeChatModel());
