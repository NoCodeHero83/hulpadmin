...
export 'detalle_solicitud_model.dart';
...
class _DetalleSolicitudWidgetState extends State<DetalleSolicitudWidget> {
  late DetalleSolicitudModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleSolicitudModel());
    ...
    _model.nombreFocusNode13 ??= FocusNode();

    _model.nombreFocusNode14 ??= FocusNode();
                      ...
                      children: [
                                          ...
                                          Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  ...
                                                  TextEditingController(
                                                text:
                                                    '${dateTimeFormat("d/M/y", columnVwSolicitudesServiciosCompletaRow?.fecha)} ${dateTimeFormat("jm", columnVwSolicitudesServiciosCompletaRow?.hora?.time)}',
                                              ),
                                              focusNode:
                                            ...
                                            child: TextFormField(
                                              ...
                                              cursorColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                              validator: _model
                                                  .nombreTextController13Validator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ].divide(SizedBox(height: 8.0)),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.nombreFocusNode14,
                                    autofocus: false,
                                    readOnly: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .nombreTextController14Validator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
                        ...
                        if (columnVwSolicitudesServiciosCompletaRow
                          ...
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              _model.showChat = !_model.showChat;
                              safeSetState(() {});
                            },
                            child: Container(
                              width: MediaQuery.sizeOf(context).width * 1.0,
                        ...
                        if (columnVwSolicitudesServiciosCompletaRow
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  'Proveedor: ${columnVwSolicitudesServiciosCompletaRow?.proveedorNombreCompleto}',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                                ...
                                Text(
                                  'Cliente: ${columnVwSolicitudesServiciosCompletaRow?.clienteNombres}',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                        ...
                        if ((columnVwSolicitudesServiciosCompletaRow
                            ...
                            _model.showChat)
                          wrapWithModel(
                            model: _model.chatUsuarioProveedorModel,
                            updateCallback: () => safeSetState(() {}),
                            child: ChatUsuarioProveedorWidget(
                              solicitud:
                                  columnVwSolicitudesServiciosCompletaRow!,
                            ),
                          ),
