...
import 'crear_proveedor_model.dart';
export 'crear_proveedor_model.dart';

class CrearProveedorWidget extends StatefulWidget {
  const CrearProveedorWidget({super.key});

  @override
  State<CrearProveedorWidget> createState() => _CrearProveedorWidgetState();
}

class _CrearProveedorWidgetState extends State<CrearProveedorWidget> {
  late CrearProveedorModel _model;
  ...
  void initState() {
    ...
    _model.numerodocumentoTextController ??= TextEditingController();
    ...
    _model.rutnitTextController ??= TextEditingController();
    _model.rutnitFocusNode ??= FocusNode();

    _model.correo1TextController ??= TextEditingController();
    _model.correo1FocusNode ??= FocusNode();

    _model.correo2TextController ??= TextEditingController();
    _model.correo2FocusNode ??= FocusNode();
                              ...
                              Flexible(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller:
                                          _model.entidadValueController ??=
                                              FormFieldController<String>(
                                        _model.entidadValue ??= 'Bancolombia',
                                      ),
                                      options: [
                                        'Bancolombia',
                                        'Davivienda',
                              ...
                              Flexible(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller:
                                          _model.tipocuentaValueController ??=
                                              FormFieldController<String>(null),
                                      options: ['Ahorro', 'Corriente'],
                                      onChanged: (val) => safeSetState(
                                          () => _model.tipocuentaValue = val),
                                      width: MediaQuery.sizeOf(context).width *
                                          1.0,
                                      height: 48.0,
                                      textStyle: FlutterFlowTheme.of(context)
                                      ...
                                      hintText: 'Seleccione el tipo de cuenta',
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
                                        color: FlutterFlowTheme.of(context)
                                            .secondaryText,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.numerocuentaTextController,
                                          focusNode:
                                              _model.numerocuentaFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.rutnitTextController,
                                          focusNode: _model.rutnitFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.correo1TextController,
                                        focusNode: _model.correo1FocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primaryText,
                                        validator: _model
                                            .correo1TextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ].divide(SizedBox(height: 8.0)),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.correo2TextController,
                                        focusNode: _model.correo2FocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primaryText,
                                        validator: _model
                                            .correo2TextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ].divide(SizedBox(height: 8.0)),
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: custom_widgets.CrearProveedor(
                              ...
                              height: 400.0,
                              serviciosid: _model.serviciosid,
