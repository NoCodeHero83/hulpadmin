...
import '/components/crear_servicio_widget.dart';
import '/components/editar_servicio_widget.dart';
import '/components/notificacion2_widget.dart';
import '/components/notificacioneliminar_widget.dart';
import '/components/ver_servicio_widget.dart';
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: FutureBuilder<List<VwResumenServiciosRow>>(
                          future: (_model.requestCompleter ??= Completer<
                                  List<VwResumenServiciosRow>>()
                                ..complete(VwResumenServiciosTable().queryRows(
                                  queryFn: (q) => q
                                      .ilike(
                                        'nombre',
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<VwResumenServiciosRow>
                                containerfiltroVwResumenServiciosRowList =
                                snapshot.data!;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            'Servicios de ${widget!.subcategoria?.nombre}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                      ...
                                      child: Container(
                                        ...
                                        child: StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<VwResumenServiciosRow>
                                                containerVwResumenServiciosRowList =
                                                snapshot.data!;
                                                    ...
                                                    final subcategorias = () {
                                                      if ((_model.textController
                                                          ...
                                                          (_model.dropDownValue !=
                                                              ...
                                                              _model.dropDownValue !=
                                                                  '')) {
                                                        return containerfiltroVwResumenServiciosRowList
                                                            .where((e) =>
                                                                _model
                                                                    .dropDownValue ==
                                                                e.estado)
                                                        ...
                                                        return containerVwResumenServiciosRowList;
                                                      }
                                                    }()
                                                        .toList();
                                                                        ...
                                                                        return Dialog(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              servicioId: subcategoriasItem.id!,
                                                                              categria: widget!.categoria!,
                                                                              subcategria: widget!.subcategoria!,
                                                                            ),
                                                                          ),
                                                                        );
                                                                      },
                                                                        ...
                                                                        return Dialog(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              texto: '¿Seguro de borrar este servicio?',
                                                                              succes: false,
                                                                              action: () async {
                                                                                await ServiciosTable().delete(
