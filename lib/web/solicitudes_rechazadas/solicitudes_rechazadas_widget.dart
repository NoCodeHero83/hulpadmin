...
import 'solicitudes_rechazadas_model.dart';
export 'solicitudes_rechazadas_model.dart';

class SolicitudesRechazadasWidget extends StatefulWidget {
  const SolicitudesRechazadasWidget({super.key});

  static String routeName = 'SolicitudesRechazadas';
  static String routePath = '/solicitudesRechazadas';

  @override
  State<SolicitudesRechazadasWidget> createState() =>
      _SolicitudesRechazadasWidgetState();
}

class _SolicitudesRechazadasWidgetState
    extends State<SolicitudesRechazadasWidget> {
  late SolicitudesRechazadasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolicitudesRechazadasModel());
                ...
                Expanded(
                  child: FutureBuilder<List<VwProfesionalesCompletoRow>>(
                    future: (_model.requestCompleter ??= Completer<
                          ...
                          ..complete(VwProfesionalesCompletoTable().queryRows(
                            queryFn: (q) => q
                                .eqOrNull(
                                  'verificado',
                                  'no verificado',
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  'Solicitudes Rechazadas Registro Talento Hulp',
                                                    ...
                                                    cells: [
                                                      ...
                                                      wrapWithModel(
                                                        ...
                                                        child:
                                                          ...
                                                          key: Key(
                                                            'Keyuzy_${proveedoresDatosIndex.toString()}',
                                                          ),
                                                          estadoActual:
                                                              valueOrDefault<
                                                                  String>(
                                                                      ...
                                                                      return Dialog(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            proveedorId:
                                                                                proveedoresDatosIndex.toString(),
                                                                          ),
                                                                        ),
                                                                      );
                                                                    },
                                                                    ...
                                                                    return Dialog(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          idproveedor:
                                                                              proveedoresDatosItem.profesionalId!,
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
