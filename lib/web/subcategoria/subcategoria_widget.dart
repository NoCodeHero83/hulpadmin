...
export 'subcategoria_model.dart';
...
class SubcategoriaWidget extends StatefulWidget {
  ...
  static String routeName = 'Subcategoria';
  static String routePath = '/subcategoria';
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: FutureBuilder<List<VwResumenSubcategoriasRow>>(
                          future: (_model.requestCompleter ??=
                                  Completer<List<VwResumenSubcategoriasRow>>()
                                    ..complete(
                                        VwResumenSubcategoriasTable().queryRows(
                                      queryFn: (q) => q
                                          .eqOrNull(
                                            'categoria_id',
                                            widget!.categoria?.id,
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<VwResumenSubcategoriasRow>
                                containerfiltroVwResumenSubcategoriasRowList =
                                snapshot.data!;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            'Subcategorías de ${widget!.categoria?.nombre}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                        ...
                                        child: Container(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<VwResumenSubcategoriasRow>
                                                  containerVwResumenSubcategoriasRowList =
                                                  snapshot.data!;
                                                  ...
                                                  builder: (context) {
                                                    final subcategorias = () {
                                                      if (_model.dropDownValue !=
                                                          ...
                                                          _model.dropDownValue !=
                                                              '') {
                                                        return containerfiltroVwResumenSubcategoriasRowList
                                                            .where((e) =>
                                                                _model
                                                                    .dropDownValue ==
                                                                e.estado)
                                                        ...
                                                        return containerVwResumenSubcategoriasRowList;
                                                      }
                                                    }()
                                                        .toList();
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Dialog(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                EditarSubcategoriaWidget(
                                                                              subcategoriaid: subcategoriasItem,
                                                                              ver: false,
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Dialog(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                NotificacioneliminarWidget(
                                                                              titulo: 'Eliminar subcategoria',
                                                                              texto: '¿Seguro de borrar esta subcategoria?',
                                                                              succes: false,
                                                                              action: () async {
                                                                                await SubcategoriasTable().delete(
                                                                                    ...
                                                                                    return Dialog(
                                                                                      ...
                                                                                      child: GestureDetector(
                                                                                        ...
                                                                                        child: Notificacion2Widget(
                                                                                          titulo: 'Subcategoria',
                                                                                          texto: 'Subcategoria eliminada exitosamente',
                                                                                          boton: 'Aceptar',
                                                                                          succes: true,
                                                                                          action: () async {
                                                                                            context.pushNamed(
